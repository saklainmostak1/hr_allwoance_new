                                    ...
                                    <form >
                                        ...
                                        <div className="form-group row">
                                            <div className="offset-md-2 col-md-8 float-left">
                                                ...
                                                />
                                                <input type="button" name="summary" class="btn btn-sm btn-primary print_summary ml-2" value="Print Summary" onClick={employee_salary_print}/>

                                                <input onClick={employee_print} type="button" name="print" class="btn btn-sm btn-success print_btn ml-2" value="Print Pay Slip" />
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                                    ...
                                                    {loading ?
                                                        ...
                                                        searchResults.map((salary, i) => (
                                                            <tr key={salary.id}>
                                                                ...
                                                                <td>{salary.created_by_name} & {salary.created_date}</td>
                                                                <td>
