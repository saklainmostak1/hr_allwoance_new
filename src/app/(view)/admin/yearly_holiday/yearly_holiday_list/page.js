...
const YearlyHolidayList = ({searchParams}) => {
    ...
    const brandList = moduleInfo.filter(moduleI => moduleI.controller_name === 'yearly_holiday')
                        ...
                        <div className="body-content bg-light">
                            <div className="border-primary shadow-sm border-0">
                                <div className="card-header py-1 custom-card-header clearfix bg-gradient-primary text-white">
                                    <h5 className="card-title font-weight-bold mb-0 card-header-color float-left mt-1">List Yearly Holiday</h5>
                                    <div className="card-title font-weight-bold mb-0 card-header-color float-right">
                                        <Link href={`/Admin/yearly_holiday/yearly_holiday_create?page_group`} className="btn btn-sm btn-info">Back Yearly Holiday Create</Link>
                                    </div>
                                </div>
                                    ...
                                    <div className='table-responsive'>
                                                        ...
                                                        <tr key={holiday_category.id}>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div className="flex items-center ">
                                                                    <Link href={`/Admin/yearly_holiday/yearly_holiday_edit/${holiday_category.id}?page_group=${page_group}`}>
                                                                    ...
                                                                    <Link href={`/Admin/yearly_holiday/yearly_holiday_copy/${holiday_category.id}?page_group=${page_group}`}>
                                        ...
                                        <div className=" d-flex justify-content-between">
                                            ...
                                            <div class="pagination float-right pagination-sm border">
                                                {
                                                    currentPage - 3 >= 1 && (
                                                        <Link className=" text-primary px-2 border-left py-1" href={`/Admin/yearly_holiday/yearly_holiday_all?page=${1}`}>‹ First</Link>
                                                    )
                                                }
                                                {
                                                    currentPage > 1 && (
                                                        <Link className=" text-primary px-2 border-left py-1" href={`/Admin/yearly_holiday/yearly_holiday_all?page=${activePage - 1}`}>&lt;</Link>
                                                    )
                                                }
                                                {
                                                    pageNumber.map((page) =>
                                                        <Link
                                                            key={page}
                                                            href={`/Admin/yearly_holiday/yearly_holiday_all?page=${page}`}
                                                ...
                                                }
                                                {
                                                    currentPage + 3 <= totalPages && (
                                                        <Link className=" text-primary px-2 border-left py-1" href={`/Admin/yearly_holiday/yearly_holiday_all?page=${totalPages}`}>Last ›</Link>
                                                    )
                                                }
                                            </div>
