...
const EmployeeLoadEdit = ({ id }) => {
    ...
    const [assetInfo, setAssetInfo] = useState({
        account: '', employee_id: '', reference: '', amount: '', interest: '', payable_amount: '', payment_type: '', loan_date: '', duration: '', per_month: '', note: '', status: '', modified_by: created, img: '', loan_reason: '', loan_type: '',
    });
        ...
        fetch(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/employe_loan/employe_loan_update/${id}`, {
            ...
            .then(data => {
                ...
                if (data) {
                    ...
                    router.push(`/Admin/employe_loan_all/employe_loan_all_all?page_group=${page_group}`);
                }
            })
            .catch(error => {
                        ...
                        <div class=" border-primary shadow-sm border-0">
                            ...
                            <form action="" onSubmit={loan_payment_create}>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-3"><strong>Payment Type Name<small><sup><small><i class="text-danger fas fa-star"></i></small></sup></small>:</strong></label>
                                        <div class="col-md-6">
                                            <select
